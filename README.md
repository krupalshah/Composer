...
- [Getting Started](#getting-started)
    ...
    - [Executing tasks concurrently](#executing-task-synchronously)
        - [Executing a collection of tasks](#executing-a-collection-of-tasks)
        - [Collecting output from multiple tasks](#collecting-output-from-multiple-tasks)
        - [Iterating over upstream results](#iterating-over-upstream-results)
