...
Having said that, the frameworks such as RxJava are far more advanced alternatives to what Composer is. The Composer is more about how you structure dependencies between your asynchronous tasks while the alternatives like RxJava is much more than just that. It makes sense to have a much simpler alternative when the structure of your asynchronous calls is pretty straightforward.
